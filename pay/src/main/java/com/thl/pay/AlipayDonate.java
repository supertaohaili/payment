...
public class AlipayDonate {
     ...
     *                 urlCode 手动解析二维码获得地址中的参数，例如 https://qr.alipay.com/aehvyvf4taua18zo6e 最后那段
     * @return 是否成功调用
     */
     ...
     * @return 是否成功调用
     */
    public static boolean startAlipayClientByPass(Activity activity, String payCode) {
        payCode = Codec.BASE64.decodeToString(payCode);
        return startIntentUrl(activity, INTENT_URL_FORMAT.replace("{payCode}", payCode));
    }
